...
class Resource {
   ...
   */
  getResById(id) {
    assert.ok(this.manifest && this.manifest.res, 'missing resource manifest');
...
Resource.configure = function configure(opt) {
  ...
  Resource.prototype.comboURI = typeof helper.comboURI === 'function' ? helper.comboURI : Resource.prototype.comboURI;
